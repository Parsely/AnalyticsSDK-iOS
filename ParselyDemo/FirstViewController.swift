...
class FirstViewController: UIViewController {
    ...
    @IBAction func didTouchButton(_ sender: Any) {
        ...
        delegate.parsely.trackPageView(url: "http://parsely.com/path/cool-blog-post/1?qsarg=nawp&anotherone=yup", metadata: ["Author": "Yogi Berra"], extra_data: ["product-id": "12345"], apikey: "subdomain.parsely-test.com")
    }
    
    @IBAction func didStartEngagement(_ sender: Any) {
        os_log("didStartEngagement", log: OSLog.default, type: .debug)
        delegate.parsely.startEngagement(url: "http://parsely.com/very-not-real", urlref:"http://parsely.com/not-real", metadata: ["Author":"Yogi Berra"], extra_data: ["product-id": "12345"], apikey: "engaged.parsely-test.com")
    }
