...
public class Parsely {
    ...
    public func startEngagement(url: String, metadata:[String: Any]? = nil, extra_data: Dictionary<String, Any> = [:]) {
        track.startEngagement(url: url, metadata:metadata, extra_data: extra_data)
    }
