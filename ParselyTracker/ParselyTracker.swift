...
public class Parsely {
    ...
    /**
     ...
     - Parameter idsite: The Parsely public API key for which the pageview event should be counted. Can be overridden
     ...
     - Parameter handleLifecycle: If true, set up listeners to handle tracking across application lifecycle events.
                                  Defaults to true.
     */
    public func configure(idsite: String, secondsBetweenHeartbeats: TimeInterval = 10, handleLifecycle: Bool = true) {
                              ...
                              idsite: String = Parsely.sharedInstance.apikey)
    {
        ...
        self.track.pageview(url: url, urlref: urlref, metadata: metadata, extra_data: extraData, idsite: idsite)
    }
    ...
    public func startEngagement(url: String,
                                ...
                                idsite: String = Parsely.sharedInstance.apikey)
    {
        track.startEngagement(url: url, urlref: urlref, extra_data: extraData, idsite: idsite)
    }
    ...
    public func trackPlay(url: String,
                          ...
                          idsite: String = Parsely.sharedInstance.apikey)
    {
        track.videoStart(url: url, urlref: urlref, vId: videoID, duration: duration, metadata: metadata, extra_data: extraData, idsite: idsite)
    }
