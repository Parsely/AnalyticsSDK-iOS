...
public class Parsely {
    ...
    public func startEngagement(url: String, urlref: String = "", metadata: Dictionary<String, Any>? = nil, extra_data: Dictionary<String, Any> = [:], idsite: String = Parsely.sharedInstance.apikey) {
